...
public class FlowResetTest {
    ...
    void shouldSendFlowStartedEventAgainAfterResetting() {
        ...
        assertThat(testFlow).flowEventsSatisfying(events -> events.nextEventIs(FlowStartedEvent.class).nextEventIs(FlowPausedEvent.class).nextEventIs(FlowStartedEvent.class).andHasNoMoreEvents());
    }
